  ...
  <section class="one-article">
    <div class="one-article__content">
      ...
      <div class="article-content__actions">
        <a
          href="#comments"
          class="article-action__item article-action__comment"
        >
          <i class="fa-solid fa-comments"></i>
        </a>
        <a
          class="article-action__item article-action__edit"
          @click="$router.push(`/article/${oneArticle.id}/edit`)"
        >
          <i class="fa-solid fa-file-pen edit__icon"></i>
        </a>
        <a
          class="article-action__item article-action__delete"
          @click="[deleteArticle(), $router.push('/article')]"
        >
